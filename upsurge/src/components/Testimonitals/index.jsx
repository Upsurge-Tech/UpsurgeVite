    ...
    <section className='bg-black'>
      ...
      >
        {testimonials.map((testimonial, i) => (
          <div
            className='flex-shrink-0 snap-center w-[500px] '
            ref={refs[i]}
            key={testimonial.id}
          >
    ...
    <div className='bg-[#18181C] rounded-[20px] text-white p-[40px] text-[18px] flex flex-col gap-[32px] font-Poppins'>
      ...
      <div className='flex justify-between items-center'>
        <div className='flex gap-[20px]'>
          <img src={testimonial.profileImage} alt='' className='w-[43px] h-[57px] rounded-[52px]' />
          <div>
            <p className='font-[600] text-[20px]'>{testimonial.name}</p>
            <p className='text-[#9E9E9E] text-[14px]'>{testimonial.description}</p>
          </div>
        </div>
...
<path d="M9.62119 17.0062L4.11902 21.8479L6.06041 13.7342L0.719238 8.61311L7.42145 8.44027L9.62119 0.433105L11.8228 8.44027L18.525 8.61311L13.182 13.7342L15.1234 21.8479L9.62119 17.0062Z" fill="#167796"/>
</svg>
}
function DarkStar() {
  return <div className='opacity-30'><BrightStar/></div>
}
